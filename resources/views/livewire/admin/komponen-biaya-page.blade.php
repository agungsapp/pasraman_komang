<div class="container-fluid px-4">
		<h1 class="text-capitalize mt-4">Data Komponen Biaya</h1>
										...
										<form wire:submit.prevent="{{ $editMode ? 'update' : 'store' }}">
												<div class="row">
														<div class="col-md-6 mb-3">
																<label for="nama" class="form-label">Nama Komponen Biaya</label>
																<input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
																		wire:model="nama" placeholder="Masukkan nama komponen biaya">
																@error('nama')
		...
		<div class="row mb-3">
				<div class="col-12">
						<div class="card">
								<div class="card-body">
										<!-- Data Table -->
										<table id="komponenTable" class="table-striped table">
												<thead>
														<tr>
																<th>No</th>
												...
												<tbody>
														@forelse($komponens as $index => $item)
																<tr>
...
@push('js')
		...
		<script>
				$(document).ready(function() {
						let table = $('#komponenTable').DataTable({
								"language": {
